...
<!-- TODO: 위 표의 시장 수치 3건(99.5억→382.8억 달러 · CAGR 27.2%)은 9/4 제출본 §04 슬라이드에도 기관명이 없다(2026-09-17 실측). 같은 슬라이드에서 출처가 붙은 것은 「유사 규모 기업 수 1,642개 — 2024 클라우드산업 실태조사」 하나다. 김세혁에게 3지선다로 문의함(보고서명 회신 / 수치 제외 후 1,642개로 대체 / 현행 유지). 회신대로 이 표와 아래 출처 줄을 고친다 -->
