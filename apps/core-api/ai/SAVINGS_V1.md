...
| v0.9.0: AI 금액 제거·서버 계산 | 60/60 가격 PASS, 단가 진단 이탈 22·과소 허용 하한 도달 16 | 서비스 후보 |
...
B의 60건에도 **단가 진단 이탈 13건·과소 허용 하한 도달 5건**이 있었다.
하한의 5건은 참조 $56.94의 −20% 경계를 센트 반올림한 $45.55와 같았다. 산출 금액을 보정한 것은 아니다.
